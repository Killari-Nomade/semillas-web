...
const Contact = () => {
  ...
  const text = encodeURIComponent('Hola Semillas Nómadas, me gustaría saber más sobre sus piezas.');
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            <div>
              ...
              <a href="mailto:hola@semillasnomadas.com" className="font-serif text-2xl text-forest hover:text-clay flex items-center gap-3">
                <Mail className="w-5 h-5" /> hola@semillasnomadas.com
              </a>
            </div>
            <div>
              <p className="overline text-clay mb-2">Instagram</p>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="font-serif text-2xl text-forest hover:text-clay flex items-center gap-3">
                <Instagram className="w-5 h-5" /> @semillas.nomadas
              </a>
            </div>
            <div>
              <p className="overline text-clay mb-2">Taller</p>
              <p className="font-serif text-2xl text-forest flex items-center gap-3">
                <MapPin className="w-5 h-5" /> Ciudad de México
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border border-line p-8 md:p-10">
            ...
            <p className="text-muted2 leading-relaxed mb-6">
              Hacemos piezas a la medida con elementos significativos para ti: la flor de tu jardín, una hoja de un viaje, semillas de tu árbol favorito.
            </p>
            <a
              href={`https://wa.me/${number}?text=${encodeURIComponent('Hola, me interesa una pieza personalizada')}`}
              target="_blank"
              rel="noopener noreferrer"
